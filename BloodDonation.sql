...
INSERT INTO `bloodTypes` (`b_id`, `blood_type`) VALUES
(1, 'A+'),
(2, 'A-'),
(3, 'B+'),
(4, 'B-'),
...
INSERT INTO `cities` (`c_id`, `gov_id`, `city_name`, `city_name_en`) VALUES
(1, 1, 'القاهره', 'Cairo'),
(2, 2, 'الجيزة', 'Giza'),
...
CREATE TABLE `donors` (
  ...
  `d_b_id` int(2) NOT NULL,
  `d_mobile` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `d_governorate` int(2) NOT NULL,
  `d_city` int(5) NOT NULL,
...
INSERT INTO `donors` (`d_id`, `d_name`, `d_b_id`, `d_mobile`, `d_governorate`, `d_city`, `email`, `created_at`, `updated_at`) VALUES
(2, 'احمد', 3, '01006566565\r\n', 1, 1, 'email@example.com', '2019-12-15 06:34:10', '2019-12-15 06:34:10'),
(3, 'محمد', 4, '01114544788\r\n', 9, 139, 'email2@example.com', '2019-12-15 06:51:19', '2019-12-15 06:51:19'),
(4, 'خالد', 6, '01113654555\r\n', 9, 139, 'email3@example.com', '2019-12-15 06:58:03', '2019-12-15 06:58:03'),
(5, 'سيد', 1, '01222244558\r\n', 16, 187, 'email4@example.com', '2019-12-15 12:16:10', '2019-12-15 12:16:10'),
(7, 'مجدى', 1, '01001478552\r\n', 1, 1, 'email6@example.com', '2019-12-16 20:20:05', '2019-12-16 20:20:05'),
(8, 'محمود', 3, '01003365455\r\n', 9, 137, 'email2@outlook.com', '2019-12-18 14:26:01', '2019-12-18 14:26:01'),
(9, 'احمد محمد', 1, '01002454555', 1, 1, 'email@outlook.com', '2019-12-18 14:46:26', '2019-12-18 14:46:26'),
(10, 'احمد محمد', 2, '01112247878', 1, 1, 'email3@outlook.com', '2019-12-18 14:59:01', '2019-12-18 14:59:01'),
(11, 'احمد مجدى', 2, '01225488789\r\n', 1, 1, 'email33@outlook.com', '2019-12-18 15:00:08', '2019-12-18 15:00:08'),
(12, 'احمد شوقى\r\n', 2, '01226555458', 1, 1, 'email4@outlook.com', '2019-12-18 15:01:50', '2019-12-18 15:01:50'),
(13, 'عابد محمد\r\n', 2, '01144777556\r\n', 1, 1, 'email5@outlook.com', '2019-12-18 15:03:18', '2019-12-18 15:03:18'),
(14, 'انس السيد', 1, '01222665598\r\n', 1, 1, 'email22@example.com', '2019-12-18 15:21:14', '2019-12-18 15:21:14'),
(15, 'عادل محمد', 1, '01055447778\r\n', 1, 1, 'email222@example.com', '2019-12-18 15:22:25', '2019-12-18 15:22:25'),
(16, 'محمد عبدالعاطى', 1, '01000144778\r\n', 1, 1, 'email2@exmple.com', '2019-12-18 15:55:36', '2019-12-18 15:55:36'),
(17, 'مالك عمرو\r\n', 3, '01112445666\r\n', 9, 142, 'e@e.com', '2019-12-19 06:52:50', '2019-12-19 06:52:50'),
(18, 'عمر عبدالعزيز\r\n', 1, '01003355544', 3, 18, 'e@w.com', '2019-12-19 10:48:48', '2019-12-19 10:48:48'),
(19, 'احمد مصطفى \r\n', 1, '01033225555', 2, 15, 'w1@v.com', '2019-12-20 12:01:58', '2019-12-20 12:01:58'),
(20, 'وائل سيد\r\n', 1, '01022244888\r\n', 10, 106, 'd@e.com', '2019-12-20 12:19:53', '2019-12-20 12:19:53'),
(21, 'احمد معارك', 5, '01097330521', 26, 145, 'marek@gmail.com', '2019-12-21 09:58:01', '2019-12-21 09:58:01');
...
(1, '2019_12_14_154355_create_doners_table', 1),
(3, '2019_12_16_112714_create_patients_table', 2);
...
CREATE TABLE `patients` (
  ...
  `p_case` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_b_id` int(11) NOT NULL,
  `hospital` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_mobile` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_governorate` int(11) NOT NULL,
...
INSERT INTO `patients` (`p_id`, `p_name`, `p_case`, `p_b_id`, `hospital`, `p_mobile`, `p_governorate`, `p_city`, `created_at`, `updated_at`) VALUES
(1, 'احمد', 'حادث', 1, '010', '010', 1, 1, '2019-12-16 19:58:30', '2019-12-16 19:58:30'),
(2, 'احمد خالد', 'حادث', 3, 'الجامعة', '011', 9, 137, '2019-12-18 20:49:56', '2019-12-18 20:49:56'),
(3, 'سيد', 'اجراء عملية', 1, 'الدمرداش', '00', 1, 1, '2019-12-18 22:05:23', '2019-12-18 22:05:23'),
(4, 'سيد', 'اجراء عملية', 1, 'الدمرداش', '001', 1, 1, '2019-12-18 22:22:03', '2019-12-18 22:22:03'),
(5, 'سيد', 'اجراء عملية', 1, 'الدمرداش', '0011', 1, 1, '2019-12-18 22:22:39', '2019-12-18 22:22:39'),
(6, 'ماجد', 'نزيف', 4, 'الابطال', '002', 9, 139, '2019-12-18 22:27:26', '2019-12-18 22:27:26'),
(7, 'سيد', 'نزيف', 1, 'برج العرب', '09', 3, 18, '2019-12-19 10:57:00', '2019-12-19 10:57:00'),
(8, 'احمد', 'حادث', 5, 'مستشفى العريش', '011111111111', 26, 145, '2019-12-21 10:08:09', '2019-12-21 10:08:09');
...
ALTER TABLE `donors`
  ...
  ADD UNIQUE KEY `doners_email_unique` (`email`) USING HASH;
...
ALTER TABLE `patients`
  ...
  ADD UNIQUE KEY `patients_p_mobile_unique` (`p_mobile`) USING HASH;
...
--
ALTER TABLE `bloodTypes`
  MODIFY `b_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `cities`
--
ALTER TABLE `cities`
  MODIFY `c_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;

--
-- AUTO_INCREMENT for table `donors`
--
ALTER TABLE `donors`
  MODIFY `d_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `patients`
  MODIFY `p_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
